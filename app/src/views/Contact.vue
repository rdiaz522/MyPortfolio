...
<style scoped></style>
<template>
  <div class="lg:h-screen lg:w-screen margin-left-right">
    <h1 class="flex mt-36 mb-12 text-2xl font-bold">REACH OUT TO ME AT:</h1>
    <div class="flex flex-row">
      <div>
        <Links
          label="ronarniediaz@gmail.com"
          img-src="https://img.icons8.com/?size=100&id=P7UIlhbpWzZm&format=png&color=000000"
          url="https://mail.google.com/mail/u/0/?fs=1&to=ronarniediaz@gmail.com&su=SUBJECT&body=BODY&tf=cm"
        />
      </div>
      <div>
        <Links label="GitHub" img-type="svg" url="https://github.com/rdiaz522">
          <svg
            class="dark:fill-white h-12 w-12"
      ...
      <div>
        <Links label="Dev.to" img-type="svg" url="https://dev.to/rondev522">
          <svg
            class="h-12 w-12 dark:fill-white"
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
            width="100"
      ...
      <div>
        <Links label="X | Twitter" img-type="svg" url="https://x.com/rondev522">
          <svg
            class="h-12 w-12 dark:fill-white"
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
